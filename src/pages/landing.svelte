<script>
    ...
    // core components
    import AuthNavbar from "./_components/Navbars/AuthNavbar.svelte";
                    ...
                    <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                        <div class="pr-12">
                            ...
                            <p class="mt-4 text-lg text-blueGray-200">
                                This is a simple example of a Landing Page you can build using Notus Svelte. It features multiple CSS
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="flex flex-wrap items-center mt-32">
                    <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                        ...
                        <a href={$url("/")} class="font-bold text-blueGray-700 mt-8"> Check Notus Svelte! </a>
                    </div>
                        ...
                        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200">
                            <div class="flex-auto p-5 lg:p-10">
                                ...
                                <div class="relative w-full mb-3 mt-8">
                                    <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" for="full-name">
                                        Full Name
                                    </label>
                                    <input
                                        id="full-name"
